...
const POND_DATA = [
  {
    ...
    peso: "31%",
    ras: [
      { id: "1.1", desc: "Formato",            act: "1.1.1", peso: "7%" },
      { id: "1.2", desc: "Objetos visuales",   act: "1.2.1", peso: "7%" },
      { id: "1.3", desc: "Envío masivo",       act: "1.3.1", peso: "17%" },
    ],
  },
  {
    label: "Presentaciones dinámicas",
    peso: "17%",
    ras: [
      { id: "2.1", desc: "Opciones de estilo", act: "2.1.1", peso: "7%" },
      { id: "2.2", desc: "Animación / IA",     act: "2.2.1", peso: "10%" },
    ],
  },
  {
    ...
    peso: "38%",
    ras: [
      { id: "3.1", desc: "Fórmulas y gráficos", act: "3.1.1", peso: "38%" },
    ],
  },
  {
    label: "Navegación / Redes",
    peso: "14%",
    ras: [
      { id: "4.1", desc: "Redes y navegadores", act: "4.1.1", peso: "14%" },
    ],
  },
];
