...
nav a.activo {
  ...
  color: #ffffff;
  font-weight: bold;
}`,rt=(e,t)=>e.replace(`<link rel="stylesheet" href="css/style.css">`,`<style>${t}</style>`),it=(e,t)=>e.replace(`<link rel="stylesheet" href="../css/style.css">`,`<style>${t}</style>`),at=tt+`
...
footer {
  ...
  letter-spacing: 2px;
  text-transform: uppercase;
}`,ct=`    // ── Hora 1: Variables y console.log ─────────────────────
...
`)}\n  <\/script>`,ft=`      <h2>Personajes principales</h2>
      ...
      <a href="paginas/personajes.html" class="btn-ver">ABRIR VISTA COMPLETA</a>`,pt=`<li><a href="#contacto">Contacto</a></li>
      <li>
  ...
  </style>`,ht=ot.replace(`</body>`,dt(ct)+`

</body>`),gt=ot.replace(`      <h2>Personajes principales</h2>
      <a href="paginas/personajes.html" class="btn-ver">ABRIR VISTA COMPLETA</a>`,ft).replace(`</body>`,dt(ct,lt)+`

</body>`),_t=ot.replace(`<link rel="stylesheet" href="css/style.css">`,mt).replace(`      <h2>Personajes principales</h2>
      <a href="paginas/personajes.html" class="btn-ver">ABRIR VISTA COMPLETA</a>`,ft).replace(`<li><a href="#contacto">Contacto</a></li>`,pt).replace(`</body>`,dt(ct,lt,ut)+`
