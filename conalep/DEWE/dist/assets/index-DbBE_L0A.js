...
`,product:`Las 5 respuestas en libreta + ejecución completa de los 9 pasos en consola. El alumno debe poder explicar por qué el paso 8 devuelve "string" aunque escriba un número.`,teacherNotes:`👨‍🏫 NOTA DOCENTE: El paso 4 es el experimento clave para entender const — vale la pena dejar que TODOS lo prueben y vean el TypeError. El paso 8-9 introduce el problema de la conversión de tipos: prompt siempre devuelve string. Si el grupo viene rápido, mostrar también que prompt("...") + 5 da "175" (concatenación) en lugar de 22 (suma) — es un error real que cometerán pronto.`},{time:`Hora 2`,title:`🌧️ Cancelado por lluvia`,theory:`Esta hora se canceló porque se suspendieron las clases por lluvia el lunes. El contenido planeado para esta hora (Primer script real — vincular js/script.js al HTML) se reprogramó para el jueves de esta misma semana.

📌 ¿QUÉ DEBES HACER?
Revisa la pestaña del jueves — ahí está la sesión completa de Primer Script Real con if/else, prompt y alert. No hay actividad obligatoria para este día.`,notebook:`Sin libreta — hora cancelada por suspensión de clases.`,practice:`Sin práctica — hora cancelada por suspensión de clases.`,product:`Sin entregable.`,teacherNotes:`👨‍🏫 NOTA DOCENTE: Lunes suspendido por lluvia. Contenido movido al jueves. Si algún alumno pregunta, indicar que el jueves se cubre lo de hoy.`},{time:`Hora 3`,title:`🌧️ Cancelado por lluvia`,theory:`Esta hora también se canceló por suspensión de clases. La sesión continúa el jueves con el primer script .js conectado al HTML.

📌 ¿QUÉ DEBES HACER?
Si te queda tiempo en casa, repasa lo que vimos en la Hora 1 (Variables y Tipos) — el jueves construimos sobre eso.`,notebook:`Sin libreta — hora cancelada por suspensión de clases.`,practice:`Sin práctica — hora cancelada por suspensión de clases.`,product:`Sin entregable.`,teacherNotes:`👨‍🏫 NOTA DOCENTE: Día suspendido. Contenido reagendado al jueves.`}],cierre:`Hoy solo alcanzamos a ver Variables y Tipos. Las dos horas restantes se cancelaron por suspensión de clases (lluvia) y se reagendaron al jueves.`,frase_docente:`Lo que esta semana parece detalle (let vs const, comillas vs backticks) la próxima semana es la diferencia entre código que corre y código que se rompe.`},{id:`thu`,label:`Jueves — 🟨 JavaScript: Primer script real (reprogramado desde lunes)`,purpose:`Sesión reprogramada desde el lunes (suspendido por lluvia). Hoy construimos el primer archivo .js conectado al HTML (H1) y lo extendemos con rangos por edad usando if/else if (H2).`,hours:[{time:`Hora 1`,title:`📄 Primer script real — JS fuera de la consola`,theory:`La consola está bien para experimentar, pero el JS de verdad vive en archivos .js que el HTML carga. Hoy creamos el primer script propio del sitio.
