...
🛡️ VALIDACIÓN BÁSICA
Si el usuario pulsa Cancelar en un prompt, devuelve null. Si solo pulsa OK sin escribir, devuelve cadena vacía "". Hay que detectar ambos casos con un if antes de seguir.`,notebook:`1. ¿Qué devuelve prompt() si el usuario pulsa Cancelar?
2. ¿Qué devuelve prompt() si pulsa OK sin escribir nada?
3. ¿Cuántas condiciones tiene tu if/else if/else extendido?
4. ¿Qué pasaría si el usuario escribe 'veinte' en lugar de '20'?`,practice:`Modifica tu script.js del jueves H1 para incluir:
