...
`)}\n  <\/script>`,ft=`      <h2>Personajes principales</h2>
  ...
  </style>`,ht=Ze.replace(`</body>`,dt(ct)+`

</body>`),gt=Ze.replace(`      <h2>Personajes principales</h2>
      <a href="paginas/personajes.html">ABRIR VISTA COMPLETA</a>`,ft).replace(`</body>`,dt(ct,lt)+`

</body>`),_t=Ze.replace(`<link rel="stylesheet" href="css/style.css">`,mt).replace(`      <h2>Personajes principales</h2>
