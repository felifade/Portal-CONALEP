...
});`},Ye={success:`✅`,info:`ℹ️`,warning:`⚠️`,error:`❌`},Xe=(e,t)=>{if(!e)return``;let n=e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`);return t===`html`?n.replace(/(&lt;!--[\s\S]*?--&gt;)|(&lt;\/?[a-zA-Z0-9]+)|(\s[a-zA-Z-]+(?==))|("[^"]*"|'[^']*')/g,(e,t,n,r,i)=>t?`<span class="token comment">${t}</span>`:n?`<span class="token tag">${n}</span>`:r?` <span class="token attr-name">${r.trim()}</span>`:i?`<span class="token string">${i}</span>`:e):t===`css`?n.replace(/(\/\*[\s\S]*?\*\/)|([^{}\s][^{}]+(?=\{))|([a-zA-Z-]+(?=\s*:))|(:[^;]+;)/g,(e,t,n,r,i)=>t?`<span class="token comment">${t}</span>`:n?`<span class="token selector">${n}</span>`:r?`<span class="token property">${r}</span>`:i?`:<span class="token value">${i.substring(1)}</span>`:e):t===`js`?n.replace(/(\/\/.*|\/\*[\s\S]*?\*\/)|\b(const|let|var|function|return|if|else|for|while|try|catch|new|async|await)\b|("[^"]*"|'[^']*'|`[^`]*`)|([0-9.]+)|([a-zA-Z0-9_]+)(?=\()/g,(e,t,n,r,i,a)=>t?`<span class="token comment">${t}</span>`:n?`<span class="token keyword">${n}</span>`:r?`<span class="token string">${r}</span>`:i?`<span class="token number">${i}</span>`:a?`<span class="token function">${a}</span>`:e):n},Ze=({value:e,onChange:t,type:n,fontSize:r})=>{let i=(0,_.useRef)(null),a=(0,_.useRef)(null),o=(0,_.useRef)(null),s=()=>{if(i.current&&a.current&&o.current){let e=a.current.scrollTop;i.current.scrollTop=e,o.current.scrollTop=e,i.current.scrollLeft=a.current.scrollLeft}},c=Array.from({length:Math.max(e.split(`
`).length,1)},(e,t)=>t+1);return(0,j.jsxs)(`div`,{className:`pro-editor-container`,children:[(0,j.jsx)(`div`,{className:`pro-gutter`,ref:o,style:{fontSize:`${r}px`,paddingTop:`16px`},children:c.map(e=>(0,j.jsx)(`div`,{className:`line-number`,children:e},e))}),(0,j.jsxs)(`div`,{className:`pro-editor-wrapper`,children:[(0,j.jsx)(`pre`,{className:`pro-highlighter`,ref:i,"aria-hidden":`true`,style:{fontSize:`${r}px`},dangerouslySetInnerHTML:{__html:Xe(e,n)+`
`}}),(0,j.jsx)(`textarea`,{className:`pro-textarea ${n}-caret`,ref:a,style:{fontSize:`${r}px`},value:e,onChange:e=>t(e.target.value),onScroll:s,spellCheck:`false`,onCopy:t=>{t.preventDefault();let n=e.substring(a.current.selectionStart,a.current.selectionEnd);n&&t.clipboardData.setData(`text/plain`,n)}})]})]})},Qe=()=>{let[e,t]=(0,_.useState)(`html`),[n,r]=(0,_.useState)(()=>localStorage.getItem(`dewe-codelab-html`)||qe.html),[i,a]=(0,_.useState)(()=>localStorage.getItem(`dewe-codelab-js`)||qe.js),[o,s]=(0,_.useState)(()=>{let e=localStorage.getItem(`dewe-codelab-css`);return e?JSON.parse(e):[{id:`m`,name:`main.css`,content:qe.cssDefault}]}),[c,l]=(0,_.useState)(`m`),[u,d]=(0,_.useState)(``),[f,p]=(0,_.useState)(15),[m,h]=(0,_.useState)([]),[g,v]=(0,_.useState)({active:!1,message:``,onConfirm:null}),[y,b]=(0,_.useState)(!1),[x,S]=(0,_.useState)(!1),[C,w]=(0,_.useState)(``),[ee,T]=(0,_.useState)(!1),[te,E]=(0,_.useState)(`mi-proyecto`),[ne,re]=(0,_.useState)(!1),ie=(0,_.useRef)(null);(0,_.useEffect)(()=>{localStorage.setItem(`dewe-codelab-html`,n)},[n]),(0,_.useEffect)(()=>{localStorage.setItem(`dewe-codelab-js`,i)},[i]),(0,_.useEffect)(()=>{localStorage.setItem(`dewe-codelab-css`,JSON.stringify(o))},[o]);let ae=(e,t=`success`)=>{let n=Date.now();h(r=>[...r,{id:n,message:e,type:t}]),setTimeout(()=>h(e=>e.filter(e=>e.id!==n)),4e3)},oe=e=>s(t=>t.map(t=>t.id===c?{...t,content:e}:t)),se=(0,_.useCallback)(()=>`<!DOCTYPE html><html><head><style>${o.map(e=>e.content).join(`
`)}</style></head><body>${n}<script>try{${i}}catch(e){console.error(e);}<\/script></body></html>`,[n,i,o]);(0,_.useEffect)(()=>{if(y)return clearTimeout(ie.current),ie.current=setTimeout(()=>d(se()),800),()=>clearTimeout(ie.current)},[n,i,o,y,se]),(0,_.useEffect)(()=>{let e=e=>{(e.metaKey||e.ctrlKey)&&e.key===`Enter`&&(e.preventDefault(),d(se()),ae(`¡Ejecutado!`,`success`))};return window.addEventListener(`keydown`,e),()=>window.removeEventListener(`keydown`,e)},[se]);let ce=()=>{d(se()),ae(`¡Vista previa actualizada!`,`info`)},D=()=>{let e=(te.trim()||`mi-proyecto`).replace(/\.html$/i,``),t=new Blob([se()],{type:`text/html`}),n=URL.createObjectURL(t),r=document.createElement(`a`);r.href=n,r.download=`${e}.html`,r.click(),URL.revokeObjectURL(n),re(!1),ae(`Descargado: ${e}.html`,`success`)},O=e=>{e===`resident`?(r(Je.html),s([{id:`m`,name:`main.css`,content:Je.css}]),a(Je.js),ae(`Plantilla Resident Evil cargada`,`info`)):(r(qe.html),s([{id:`m`,name:`main.css`,content:qe.cssDefault}]),a(qe.js),ae(`Plantilla básica cargada`,`info`))},le=()=>{let e=C.trim();if(!e)return;let t=e.endsWith(`.css`)?e:`${e}.css`,n=Date.now().toString();s(e=>[...e,{id:n,name:t,content:``}]),l(n),w(``),S(!1)},ue=e===`html`?n:e===`css`?o.find(e=>e.id===c)?.content||``:i,de=ue.split(`
`).length,fe=o.find(e=>e.id===c)?.name||`main.css`,k=e===`css`?fe:e.toUpperCase();return(0,j.jsxs)(`div`,{className:`codelab-container`,children:[(0,j.jsxs)(`header`,{className:`codelab-header`,children:[(0,j.jsxs)(`div`,{className:`codelab-info`,children:[(0,j.jsx)(`span`,{className:`lab-badge`,children:`CodeLab`}),(0,j.jsx)(`h1`,{className:`lab-title`,children:`Editor de Código`})]}),(0,j.jsxs)(`div`,{className:`codelab-actions`,children:[(0,j.jsxs)(`select`,{className:`template-select`,defaultValue:``,onChange:e=>{e.target.value&&(O(e.target.value),e.target.value=``)},children:[(0,j.jsx)(`option`,{value:``,disabled:!0,children:`Plantilla…`}),(0,j.jsx)(`option`,{value:`basic`,children:`Básica`}),(0,j.jsx)(`option`,{value:`resident`,children:`Resident Evil`})]}),(0,j.jsx)(`div`,{className:`divider`}),(0,j.jsxs)(`div`,{className:`font-controls`,children:[(0,j.jsx)(`button`,{className:`font-btn`,onClick:()=>p(e=>Math.max(10,e-2)),children:`A−`}),(0,j.jsx)(`span`,{className:`font-val`,children:f}),(0,j.jsx)(`button`,{className:`font-btn`,onClick:()=>p(e=>Math.min(30,e+2)),children:`A+`})]}),(0,j.jsx)(`div`,{className:`divider`}),(0,j.jsx)(`button`,{className:`lab-btn autorun-btn ${y?`autorun-on`:``}`,onClick:()=>b(e=>!e),title:`Ejecutar automáticamente mientras escribes`,children:`⚡ Auto`}),(0,j.jsx)(`button`,{className:`lab-btn help`,title:`Copiar todo el proyecto`,onClick:()=>navigator.clipboard.writeText(se()).then(()=>ae(`¡Proyecto copiado!`,`success`)),children:`Copiar`}),ne?(0,j.jsxs)(`div`,{className:`download-inline`,children:[(0,j.jsx)(`input`,{autoFocus:!0,className:`download-name-input`,value:te,onChange:e=>E(e.target.value),onKeyDown:e=>{e.key===`Enter`&&D(),e.key===`Escape`&&re(!1)},placeholder:`nombre-archivo`,maxLength:40}),(0,j.jsx)(`span`,{className:`download-ext`,children:`.html`}),(0,j.jsx)(`button`,{className:`add-file-confirm`,onClick:D,title:`Descargar`,children:`↓`}),(0,j.jsx)(`button`,{className:`add-file-cancel`,onClick:()=>re(!1),children:`×`})]}):(0,j.jsx)(`button`,{className:`lab-btn download-btn`,onClick:()=>re(!0),children:`↓ Guardar`}),(0,j.jsx)(`button`,{className:`lab-btn danger`,title:`Limpiar todo el código`,onClick:()=>v({active:!0,message:`¿Limpiar todo el código?`,onConfirm:()=>{r(``),s([{id:`m`,name:`main.css`,content:``}]),a(``),d(``),ae(`Código limpiado`,`warning`)}}),children:`Limpiar`}),(0,j.jsx)(`button`,{className:`lab-btn primary`,onClick:ce,title:`Cmd+Enter / Ctrl+Enter`,children:`▶ Ejecutar`})]})]}),(0,j.jsxs)(`div`,{className:`codelab-main`,children:[(0,j.jsxs)(`div`,{className:`editor-pane`,children:[(0,j.jsxs)(`div`,{className:`tab-navigation`,children:[(0,j.jsx)(`button`,{className:`tab-link html ${e===`html`?`active`:``}`,onClick:()=>t(`html`),children:`HTML`}),(0,j.jsxs)(`button`,{className:`tab-link css  ${e===`css`?`active`:``}`,onClick:()=>t(`css`),children:[`CSS `,o.length>1&&(0,j.jsx)(`span`,{className:`tab-count`,children:o.length})]}),(0,j.jsx)(`button`,{className:`tab-link js   ${e===`js`?`active`:``}`,onClick:()=>t(`js`),children:`JS`}),(0,j.jsx)(`div`,{className:`tab-spacer`}),(0,j.jsx)(`span`,{className:`shortcut-hint`,children:`⌘ + Enter para ejecutar`})]}),e===`css`&&(0,j.jsxs)(`div`,{className:`file-bar`,children:[o.map(e=>(0,j.jsxs)(`div`,{className:`file-tab ${c===e.id?`active`:``}`,onClick:()=>l(e.id),children:[(0,j.jsx)(`span`,{children:e.name}),o.length>1&&(0,j.jsx)(`button`,{className:`file-icon-btn delete`,onClick:t=>{t.stopPropagation(),v({active:!0,message:`¿Borrar "${e.name}"?`,onConfirm:()=>{s(o.filter(t=>t.id!==e.id)),l(`m`)}})},children:`×`})]},e.id)),x?(0,j.jsxs)(`div`,{className:`add-file-inline`,children:[(0,j.jsx)(`input`,{autoFocus:!0,className:`add-file-input`,value:C,onChange:e=>w(e.target.value),onKeyDown:e=>{e.key===`Enter`&&le(),e.key===`Escape`&&(S(!1),w(``))},placeholder:`nombre.css`,maxLength:32}),(0,j.jsx)(`button`,{className:`add-file-confirm`,onClick:le,children:`✓`}),(0,j.jsx)(`button`,{className:`add-file-cancel`,onClick:()=>{S(!1),w(``)},children:`×`})]}):(0,j.jsx)(`button`,{className:`add-file-btn`,onClick:()=>S(!0),title:`Nuevo archivo CSS`,children:`+`})]}),(0,j.jsx)(`div`,{className:`editor-body`,children:(0,j.jsx)(Ze,{value:ue,onChange:e===`html`?r:e===`css`?oe:a,type:e,fontSize:f})}),(0,j.jsxs)(`div`,{className:`editor-status`,children:[(0,j.jsx)(`span`,{className:`status-lang lang-${e}`,children:k}),(0,j.jsxs)(`div`,{className:`status-right`,children:[(0,j.jsxs)(`span`,{children:[de,` `,de===1?`línea`:`líneas`]}),(0,j.jsx)(`span`,{className:`status-sep`,children:`·`}),(0,j.jsxs)(`span`,{children:[`Zoom `,f,`px`]})]})]})]}),(0,j.jsxs)(`div`,{className:`preview-pane ${ee?`collapsed`:``}`,children:[(0,j.jsxs)(`div`,{className:`pane-header preview-header`,children:[!ee&&(0,j.jsx)(`span`,{className:`preview-dot ${y?`live`:``}`}),!ee&&(0,j.jsx)(`span`,{children:`Vista previa`}),!ee&&y&&(0,j.jsx)(`span`,{className:`live-badge`,children:`EN VIVO`}),(0,j.jsx)(`button`,{className:`preview-toggle-btn`,onClick:()=>T(e=>!e),title:ee?`Expandir vista previa`:`Colapsar vista previa`,children:ee?`◀`:`▶`})]}),(0,j.jsx)(`iframe`,{title:`preview`,className:`preview-iframe`,srcDoc:u||se()})]})]}),(0,j.jsx)(`div`,{className:`toast-container`,children:m.map(e=>(0,j.jsxs)(`div`,{className:`toast-item ${e.type}`,children:[(0,j.jsx)(`span`,{className:`toast-icon`,children:Ye[e.type]||`✅`}),(0,j.jsx)(`span`,{children:e.message})]},e.id))}),g.active&&(0,j.jsx)(`div`,{className:`confirm-overlay`,children:(0,j.jsxs)(`div`,{className:`confirm-modal`,children:[(0,j.jsx)(`h3`,{children:`Confirmar`}),(0,j.jsx)(`p`,{children:g.message}),(0,j.jsxs)(`div`,{className:`confirm-actions`,children:[(0,j.jsx)(`button`,{className:`confirm-btn cancel`,onClick:()=>v({active:!1}),children:`Cancelar`}),(0,j.jsx)(`button`,{className:`confirm-btn danger`,onClick:()=>{g.onConfirm(),v({active:!1})},children:`Confirmar`})]})]})})]})},$e=`<!DOCTYPE html>
<html lang="es">
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
`)}\n  <\/script>`,pt=`      <h2>Personajes principales</h2>
      ...
      <a href="paginas/personajes.html" class="btn-ver">ABRIR VISTA COMPLETA</a>`,mt=`<li><a href="#contacto">Contacto</a></li>
      <li>
      ...
      </li>`,ht=`<link rel="stylesheet" href="css/style.css">
  <style>
    /* ── W10 H3: Modo claro ───────────────────────────────── */
  ...
  </style>`,gt=ct.replace(`</body>`,M(ut)+`

</body>`),_t=ct.replace(`      <h2>Personajes principales</h2>
      <a href="paginas/personajes.html" class="btn-ver">ABRIR VISTA COMPLETA</a>`,pt).replace(`</body>`,M(ut,dt)+`

</body>`),vt=ct.replace(`<link rel="stylesheet" href="css/style.css">`,ht).replace(`      <h2>Personajes principales</h2>
      <a href="paginas/personajes.html" class="btn-ver">ABRIR VISTA COMPLETA</a>`,pt).replace(`<li><a href="#contacto">Contacto</a></li>`,mt).replace(`</body>`,M(ut,dt,ft)+`

</body>`),yt=`// Agregar antes de </body> en index.html
...
console.log("Bienvenido a: " + titulo);
console.log("Versión: " + version);
console.log("Año: " + anio);`,bt=`<!-- Agregar en #personajes, después del <h2> -->

<button onclick="mostrarInfo()">🔍 Más información</button>
<p id="info-extra" style="display:none; margin-top:8px; color:#888;">
  Los personajes son agentes especiales que combaten amenazas biológicas.
  Cada uno tiene habilidades únicas de combate y supervivencia.
</p>`,xt=`// Agregar dentro del <script>
...
}`,St=`/* Agregar en <head>, dentro de un <style> nuevo */
...
body.modo-claro h2 {
  color: #b91c1c;
}`,Ct=`<!-- Agregar en <nav>, al final de la <ul> -->
...
</li>`,wt=`// Agregar dentro del <script>
