...
`,
    ...
    },
    {
      ...
      purpose: "Sesión pendiente. Posibles direcciones: arrays + inventario, refactor con localStorage, o repaso integrador para evaluación final.",
      hours: [
        {
          time: "🚧 Por planear",
          title: "🚧 Sesión por planear",
          theory: "Esta sesión se planeará después del lunes según el avance del grupo. Direcciones probables:\n\n• Arrays + inventario de items recogibles (pistola, hierba, llave).\n• localStorage para guardar progreso entre recargas.\n• Repaso integrador con vistas a la evaluación final del semestre.\n• Práctica libre y atención a casos que se atoraron.",
          notebook: "Sin libreta — sesión por confirmar.",
          practice: "Sin práctica obligatoria.",
          product: "Por definir.",
          teacherNotes: "👨‍🏫 NOTA DOCENTE: Decidir en función del avance del lunes y la cercanía a la evaluación final del semestre."
        }
      ],
      cierre: "Sesión por definir.",
      frase_docente: "Las dos últimas sesiones del semestre son momento de mirar atrás antes de mirar adelante."
    },
    {
      id: "fri",
