...
- Tipografía
- Wireframe
- Mapa del sitio`}]},W06:{materia:`dewe`,weekId:`W06`,days:[{id:`mon`,label:`Lunes — Estructura HTML`,hours:[{time:`Hora 1`,theory:`HTML permite estructurar una página web mediante etiquetas.`,notebook:`Escribe la estructura básica HTML.`,practice:`Crear archivo HTML base.`,code:`<!DOCTYPE html>
<html>
  <head>
    <!-- ¿Qué va aquí? -->
  </head>
...
</html>`},{time:`Hora 2`,theory:`Las etiquetas organizan el contenido.`,notebook:`Lista etiquetas básicas.`,practice:`Agregar títulos y párrafos.`,code:`<!-- Agrega un título y un párrafo -->
<h1></h1>
<p></p>`,codeRef:`<h1>Resident Evil</h1>
<p>Saga de videojuegos de terror y acción.</p>`},{time:`Hora 3`,theory:`Las secciones ayudan a organizar la página.`,notebook:`Explica section y article.`,practice:`Agregar secciones.`,code:`<!-- Crea una sección con id y un subtítulo -->
<section id="">
  <h2></h2>
</section>`,codeRef:`<section id="personajes">
  <h2>Personajes principales</h2>
</section>

<section id="juegos">
  <h2>Juegos de la saga</h2>
</section>`}]},{id:`thu`,label:`Jueves — Contenido del sitio`,hours:[{time:`Hora 1`,theory:`Las listas permiten organizar información.`,notebook:`Ejemplo lista.`,practice:`Crear lista de juegos.`,code:`<!-- Lista sin orden — agrega al menos 5 juegos -->
<ul>
  <li></li>
  <li></li>
  <li></li>
...
</ul>`},{time:`Hora 2`,theory:`Las tablas organizan datos.`,notebook:`Dibuja tabla.`,practice:`Crear tabla.`,code:`<!-- Tabla con encabezados y al menos 3 filas -->
<table>
  <tr>
    <th></th>
    <th></th>
...
</table>`}]},{id:`fri`,label:`Viernes — Formulario y cierre`,hours:[{time:`Hora 1`,theory:`Los formularios capturan datos.`,notebook:`Ejemplo de formulario.`,practice:`Crear formulario.`,code:`<!-- Formulario con al menos nombre y correo -->
<form>
  <label>:</label><br>
  <input type=""><br><br>
...
</form>`},{time:`Hora 2`,theory:`Los enlaces permiten navegar.`,notebook:`Ejemplo enlace.`,practice:`Agregar navegación.`,code:`<!-- Crea un menú con al menos 3 enlaces internos -->
<nav>
  <a href="#">Sección 1</a>
  <a href="#">Sección 2</a>
</nav>`,codeRef:`<nav>
...
</nav>`},{time:`Hora 3`,theory:`Un sitio completo integra todo.`,notebook:`Describe tu sitio.`,practice:`Integrar proyecto.`,code:`<!-- Proyecto completo -->`}]},{id:`dual`,label:`Actividad Dual — Infografía en libreta`,content:`Instrucción:
...
- Listas
- Tablas
- Formularios`}]},W07:{materia:`dewe`,weekId:`W07`,days:[{id:`mon`,label:`Lunes — Organización del proyecto web`,purpose:`Tomar el sitio HTML trabajado en la Semana 06 y convertirlo en un proyecto web organizado, comprendiendo la importancia de las carpetas, los nombres de archivos y la estructura lógica del sitio.`,hours:[{time:`Hora 1`,title:`Estructura de un proyecto web`,theory:`Un sitio web no está formado por un solo archivo. Aunque al principio parezca que todo vive dentro de un documento HTML, en realidad un proyecto web se construye con varios archivos organizados dentro de carpetas. Esta organización permite trabajar con orden, corregir errores con mayor facilidad y ampliar el sitio sin perder el control del proyecto. En desarrollo web, normalmente el archivo principal se llama index.html, porque es la página de entrada del sitio. Además, es común separar los recursos: por ejemplo, las imágenes se guardan en una carpeta llamada img y las hojas de estilo se guardan en una carpeta llamada css. Esta lógica no solo sirve para que el proyecto se vea ordenado, sino también para que el navegador encuentre correctamente los recursos que necesita. Un proyecto desorganizado puede provocar archivos perdidos, enlaces rotos, rutas incorrectas y dificultades para seguir trabajando más adelante. Por eso, antes de pensar en diseño o en más páginas, primero hay que entender cómo se organiza un proyecto web.`,notebook:`Título: Estructura de un proyecto web. Instrucciones: 1. Dibuja una carpeta principal llamada Sitio_Resident_Evil. 2. Dentro de esa carpeta dibuja el archivo index.html. 3. Agrega dos carpetas internas llamadas img y css. 4. Debajo del dibujo escribe qué función cumple cada elemento. 5. Finalmente responde: ¿Por qué es importante organizar un proyecto web desde el inicio?`,practice:`1. En el escritorio o en la carpeta de trabajo crear una carpeta llamada Sitio_Resident_Evil. 2. Entrar a esa carpeta y crear dos carpetas internas: img y css. 3. Verificar que los nombres estén escritos correctamente, sin espacios extra ni errores de mayúsculas. 4. Mostrar al docente la estructura creada antes de continuar. 5. No avanzar hasta confirmar que la base del proyecto quedó correcta.`,code:`Sitio_Resident_Evil/
├── img/
└── css/`,product:`Carpeta principal del proyecto creada correctamente con las subcarpetas img y css.`,teacherNotes:`👨‍🏫 NOTA DOCENTE: Aquí conviene insistir en que todavía no se diseña ni se mete CSS. El objetivo es que entiendan la lógica de organización. Revisa nombres de carpetas uno por uno, porque muchos alumnos escriben mal css o crean la carpeta fuera del proyecto.`},{time:`Hora 2`,title:`Reutilización del HTML de la Semana 06`,theory:`En la Semana 06 se construyó una página completa en HTML sobre Resident Evil. Ese trabajo ya no debe verse como un ejercicio aislado, sino como la base de un proyecto web real. En desarrollo web no siempre se empieza desde cero. Muchas veces se reutiliza código, se reorganiza y se mejora. Eso significa que el trabajo anterior tiene valor y puede crecer. Ahora el objetivo no es rehacer toda la página, sino aprender a integrarla correctamente en una estructura de proyecto. También es importante comprender que cada elemento HTML cumple una función específica dentro del sitio: algunos organizan la estructura general, otros contienen información, otros ayudan a navegar y otros permiten capturar datos. Reconocer lo que ya tiene el sitio ayuda al alumno a ver que ya no está empezando, sino avanzando sobre una base real. Este paso es importante porque conecta lo aprendido anteriormente con la nueva lógica del proyecto.`,notebook:`Título: Elementos HTML que ya tiene mi sitio. Instrucciones: 1. Haz una lista con las etiquetas y elementos que ya tiene tu página de Resident Evil. 2. Incluye al menos los siguientes: header, nav, section, article, img, ul, ol, table, form, footer. 3. Junto a cada uno escribe para qué sirve. 4. Al final responde: ¿Qué parte de mi sitio está mejor lograda y cuál necesita mejorar?`,practice:`1. Dentro de la carpeta Sitio_Resident_Evil crear el archivo index.html. 2. Abrir ese archivo en el editor de texto o IDE que estén usando. 3. Copiar o reescribir el HTML trabajado en la Semana 06 sobre Resident Evil. 4. Guardar correctamente el archivo. 5. Abrir index.html en el navegador y revisar que el contenido principal aparezca. 6. Si hay errores, corregirlos antes de continuar.`,code:`<!DOCTYPE html>
<html lang="es">
<head>
  <meta charset="UTF-8">
...
</html>`,product:`Archivo index.html creado y funcionando con el contenido base del proyecto.`,teacherNotes:`👨‍🏫 NOTA DOCENTE: Aquí no se trata de que reescriban todo perfecto desde memoria, sino de que comprendan que están convirtiendo un ejercicio en un proyecto. Puedes pedir que localicen visualmente en su HTML dónde está el header, el nav o el form.`},{time:`Hora 3`,title:`Pensar el crecimiento del sitio web`,theory:`Un sitio web puede comenzar como una sola página, pero cuando su contenido crece, conviene dividirlo en varias páginas para organizar mejor la información. Esto ayuda a que el usuario navegue con mayor claridad y a que el desarrollador mantenga mejor el proyecto. Por ejemplo, en el sitio de Resident Evil se puede dejar una página principal con la información general y después separar apartados como personajes, juegos o contacto en archivos distintos. Pensar de esta manera ayuda al alumno a dejar de ver HTML como un conjunto de etiquetas sueltas y empezar a verlo como una estructura de información. Un buen desarrollador no solo programa, también decide cómo organizar el contenido para que tenga lógica. Esta hora no busca todavía separar el proyecto en varias páginas, sino que el alumno visualice esa posibilidad y empiece a preparar mentalmente la navegación que trabajará después.`,notebook:`Título: Posibles páginas de mi sitio. Instrucciones: 1. Escribe qué partes del sitio Resident Evil podrían convertirse en páginas separadas. 2. Menciona al menos tres: personajes, juegos, contacto. 3. Dibuja un esquema sencillo donde muestres cuál sería la página principal y cuáles serían las secundarias. 4. Explica por qué convendría dividir esa información en varios archivos y no dejarla toda en una sola página.`,practice:`1. Revisar index.html en el navegador. 2. Confirmar que el contenido principal cargue correctamente. 3. Corregir errores visibles en títulos, párrafos o etiquetas sin cerrar. 4. Identificar dentro del archivo qué secciones podrían ir después en otros archivos HTML. 5. Guardar una versión ordenada y funcional del proyecto al finalizar la clase.`,code:`<!-- ¿Qué secciones de tu sitio podrían ser páginas separadas? -->
<section id="">
  <h2></h2>
  <article>
    <h3></h3>
...
</section>`,product:`Proyecto base funcional con index.html revisado y esquema inicial de crecimiento del sitio.`,teacherNotes:`👨‍🏫 NOTA DOCENTE: Aquí puedes cerrar la sesión haciendo que verbalicen: 'Hoy no hice una página suelta, empecé un proyecto web'. Eso les cambia el chip. También conviene revisar que todos realmente tengan el archivo dentro de la carpeta correcta.`}]},{id:`thu`,label:`Jueves — Navegación interna y uso de ID`,purpose:`Reforzar el uso de enlaces internos dentro del mismo documento HTML (index.html), comprendiendo la relación exacta entre el atributo href y el identificador id para crear una navegación fluida.`,hours:[{time:`Hora 1`,title:`Enlaces internos y tipos de enlaces`,theory:`Los enlaces en HTML permiten conectar distintas partes de un sitio web. Los enlaces internos permiten moverse dentro de la misma página. Se crean con la etiqueta <a> y el atributo href. Cuando el valor de href inicia con el símbolo #, el enlace apunta a un elemento dentro del mismo documento. Ese elemento debe tener un atributo id que coincida exactamente. Ejemplo: <a href="#contacto"> <section id="contacto"> Además, existen otros tipos de enlaces: 1. Enlaces internos (#) → misma página, 2. Enlaces a otra página → archivo HTML, 3. Enlaces externos → sitios web.`,notebook:`Título: Tipos de enlaces en HTML. 1. Escribe los 3 tipos de enlaces. 2. Escribe un ejemplo de cada uno. 3. Explica cuándo usarías cada tipo. 4. ¿Qué pasa si el id no coincide con el href?`,practice:`1. Abrir el archivo index.html del proyecto. 2. Localizar el menú dentro de la etiqueta <nav>. 3. Identificar los enlaces que ya existen (#personajes, #juegos, etc.). 4. Agregar una nueva opción en el menú: <a href="#inicio">Inicio</a>. 5. Buscar el encabezado principal (<header>). 6. Modificarlo para agregar el id: <header id="inicio">. 7. Guardar el archivo. 8. Abrir el archivo en el navegador. 9. Hacer clic en el enlace "Inicio". 10. Verificar que la página se desplace correctamente al inicio.`,code:`<!-- ¿Cómo conectas el enlace con el id correcto? -->
<a href="#">Inicio</a>

<header id="">`,codeRef:`<a href="#inicio">Inicio</a>

<header id="inicio">`,product:`Menú actualizado con un enlace interno funcional que desplaza correctamente dentro de la página`,teacherNotes:`Aquí no los dejes avanzar rápido. Haz que TODOS prueben el enlace. Si no hacen clic, no aprenden.`},{time:`Hora 2`,title:`Navegación interna dentro del documento`,theory:`La verdadera navegación interna depende de que los IDs estén colocados estratégicamente en las secciones del sitio. Un error en una sola letra del ID hará que el enlace no funcione. Es fundamental que el alumno entienda que el símbolo # le dice al navegador: 'busca este nombre dentro de este mismo archivo'.`,notebook:`Título: Navegación dentro del mismo documento. 1. ¿Cuál es la función del símbolo # en el href? 2. ¿En qué etiqueta debe colocarse el atributo id para que el salto sea exitoso? 3. Dibuja el flujo: Clic en enlace -> El navegador busca el ID -> Desplazamiento visual.`,practice:`1. Revisar cada <section> de index.html. 2. Asegurarse de que tengan IDs únicos (personajes, juegos, contacto). 3. Verificar que los enlaces del nav apunten exactamente a esos nombres precedidos por #. 4. Probar cada enlace en el navegador y corregir errores de ortografía en los nombres.`,code:`<!-- El href y el id deben coincidir exactamente -->
<a href="#">Personajes</a>

<section id="">`,codeRef:`<a href="#personajes">Personajes</a>

<section id="personajes">`,product:`Navegación interna 100% funcional entre todas las secciones del index.html`,teacherNotes:`El error más común es olvidar el # en el href o escribir el ID con mayúsculas/minúsculas diferentes. Haz que sean minuciosos.`}],cierre:`Hoy tu página aprendió a navegar por sí misma sin necesidad de archivos externos todavía.`,frase_docente:`Un enlace sin un ID correspondiente es como enviar una carta a una casa sin número.`},{id:`fri`,label:`Viernes — Transición a la primera página externa`,purpose:`Iniciar la transición de una página única a un sitio web real mediante la creación y conexión del archivo personajes.html, comprendiendo la diferencia entre navegación interna y externa.`,hours:[{time:`Hora 1`,title:`Repaso de enlaces internos vs. externos`,theory:`Hasta ahora el sitio funciona como una sola página utilizando enlaces internos (#). Sin embargo, los sitios web reales están formados por múltiples archivos HTML conectados. Un enlace interno (#) busca contenido dentro del mismo archivo. Un enlace a archivo busca un documento nuevo en la misma carpeta.`,notebook:`Título: Enlaces internos vs. Archivos externos. 1. Explica la diferencia entre <a href="#personajes"> y <a href="personajes.html">. 2. ¿Por qué es necesario crear archivos independientes para sitios grandes? 3. Dibuja el mapa: index.html -> personajes.html.`,practice:`1. Abrir index.html y localizar el nav. 2. Analizar el código actual. 3. Discutir por qué usar '#' limita el crecimiento de la página si hay mucha información.`,code:`<!-- ¿Cuál es la diferencia? Completa los href -->
<!-- Enlace interno (misma página): -->
<a href="">Personajes</a>

<!-- Enlace externo (otro archivo): -->
<a href="">Personajes</a>`,codeRef:`<!-- Interno — salta dentro del mismo archivo -->
<a href="#personajes">Personajes</a>

<!-- Externo — abre otro archivo .html -->
<a href="personajes.html">Personajes</a>`,product:`Comprensión clara de la diferencia entre ambos tipos de navegación`,teacherNotes:`Asegúrate de que entiendan que al cambiar el href a personajes.html, el navegador ya no saltará hacia abajo, sino que cargará un nuevo archivo.`},{time:`Hora 2`,title:`Creación del archivo personajes.html`,theory:`Cada página de un sitio web debe ser un archivo .html independiente. Estos archivos deben vivir en la misma carpeta principal para que el navegador los encuentre fácilmente. Aunque sea una página nueva, debe seguir teniendo la estructura básica (html, head, body).`,notebook:`Título: Estructura de personajes.html. 1. Escribe la estructura básica necesaria para el nuevo archivo. 2. ¿Qué título le pondrás a esta pestaña en la etiqueta <title>?`,practice:`1. Crear un nuevo archivo en la carpeta del proyecto. 2. Nombrarlo exactamente como: personajes.html. 3. Escribir la estructura básica de HTML5. 4. Agregar un título <h1>Personajes</h1> y un párrafo <p>Página en construcción</p>. 5. Guardar el archivo.`,code:`<!DOCTYPE html>
<html lang="es">
<head>
  <meta charset="UTF-8">
...
</html>`,product:`Archivo personajes.html creado y listo para ser enlazado`,teacherNotes:`El error más común aquí es que guarden el archivo con errores de dedo en el nombre. 'personaje.html' (sin s) romperá el enlace después.`},{time:`Hora 3`,title:`Conexión y prueba de navegación`,theory:`Para que el usuario pueda llegar a la nueva página, debemos modificar el enlace en el menú del index.html. Al quitar el símbolo # y poner el nombre del archivo, el navegador entenderá que debe salir del documento actual y abrir el nuevo.`,notebook:`Título: Conexión entre páginas. 1. ¿Cómo quedó el enlace final en el nav? 2. ¿Qué sucede en el navegador cuando haces clic? 3. ¿Cómo podrías regresar al inicio desde personajes.html?`,practice:`1. Regresar al archivo index.html. 2. Localizar el enlace de Personajes en el menú. 3. Cambiar href="#personajes" por href="personajes.html". 4. Guardar index.html. 5. Abrir index.html en el navegador. 6. Probar el menú y verificar que se abra la nueva página de Personajes.`,code:`<!-- Cambia el href para que abra un archivo externo -->
<a href="">Personajes</a>`,codeRef:`<a href="personajes.html">Personajes</a>`,product:`Navegación funcional entre el index y la nueva página externa`,teacherNotes:`Si el enlace no funciona, es casi seguro que el nombre del archivo no coincide exactamente con el href. Haz que revisen letra por letra.`}],cierre:`Hoy tu página dejó de ser un solo documento y comenzó su transformación en un sitio web profesional.`,frase_docente:`La web no es una hoja, es una red de páginas conectadas entre sí.`},{id:`dual`,label:`Repositorio de Actividades Duales (Semana 07)`,activities:[{title:`Tarea 1: Estructura del proyecto`,instruction:`Basado en la infografía adjunta: 1. Certifica que tu carpeta raíz 'Sitio_Resident_Evil' contenga las subcarpetas img y css. 2. Verifica que el archivo index.html esté en la raíz y no dentro de las carpetas. 3. Identifica en tu libreta qué contenido de tu página actual se moverá a páginas independientes.`,image:`infografia_lunes.png`},{title:`Tarea 2: Navegación y Enlaces Internos`,instruction:`Utiliza la infografía 'Navegación y Enlaces Internos HTML' para: 1. Identificar la diferencia entre un enlace externo y un marcador interno (#). 2. Dibujar en tu libreta el esquema de navegación mostrado. 3. Escribir el código de un menú nav que contenga al menos 3 enlaces a secciones de una misma página.`,image:`infografia_jueves.png`}]},{id:`key`,label:`Código Clave — Navegación`,hours:[{time:`Snippets de la semana`,theory:`Resumen de los bloques de código más importantes para la navegación interna y externa.`,notebook:`Anotar en la sección de apuntes rápidos.`,practice:`Usar estos bloques como referencia constante.`,code:`<!-- Completa los valores correctos -->
<header id="">
<a href="">Inicio</a>

<a href="">Ver Personajes</a>`,codeRef:`<!-- Salto interno -->
<header id="inicio">
<a href="#inicio">Inicio</a>

<!-- Salto externo (nuevo archivo) -->
<a href="personajes.html">Ver Personajes</a>`}]}]},W08:{materia:`dewe`,weekId:`W08`,days:[{id:`mon`,label:`Lunes — Rutas relativas y expansión del sitio web`,purpose:`Comprender y aplicar correctamente las rutas relativas en un proyecto web, integrando múltiples páginas con imágenes y navegación funcional.`,hours:[{time:`Hora 1`,title:`Página juegos.html y rutas relativas`,theory:`En un sitio web, los archivos se organizan en carpetas para mantener orden. Para conectar estos archivos se utilizan rutas relativas. El símbolo ../ significa subir un nivel en la estructura de carpetas. Ejemplo: para acceder a una imagen desde 'paginas/juegos.html', la ruta sería '../img/archivo.jpg'. Si la ruta está mal escrita, el recurso no se mostrará.`,notebook:`Título: Rutas relativas en HTML. 1. Copia el dictado completo. 2. Dibuja la estructura del proyecto. 3. Responde: ¿Cómo accedes a juegos.html desde index.html? ¿Cómo accedes a una imagen desde juegos.html? ¿Qué significa '../'? 4. Escribe 2 errores comunes al usar rutas.`,practice:`1. Crear o abrir paginas/juegos.html. 2. Agregar título y lista de al menos 5 juegos. 3. Insertar mínimo 5 imágenes usando ../img/archivo.jpg. 4. Asegurar que tengan atributo alt y funcionen correctamente. 5. Agregar navegación: <a href="../index.html">Inicio</a>. 6. Probar en navegador y corregir errores de ruta.`,code:`<!-- Completa las rutas correctas -->
<img src="" alt="">
<img src="" alt="">
<img src="" alt="">

<!-- ¿Cómo regresas al inicio desde paginas/? -->
<a href="">Inicio</a>`,codeRef:`<img src="../img/re4.jpg" alt="Resident Evil 4">
<img src="../img/re7.jpg" alt="Resident Evil 7">
<img src="../img/re_village.jpg" alt="RE Village">

<!-- Desde paginas/ se sube un nivel con ../ -->
<a href="../index.html">Inicio</a>`,product:`Página juegos.html con múltiples imágenes correctamente enlazadas usando rutas relativas`,teacherNotes:`Aquí se detecta quién entiende rutas. No ayudar de inmediato. Hacer que el alumno identifique el error por su cuenta.`},{time:`Hora 2`,title:`Página cronologia.html con imágenes`,theory:`Una cronología permite organizar eventos en orden dentro de una página web. El uso de listas ordenadas (<ol>) permite estructurar la información de forma clara. Al igual que en juegos.html, las imágenes en esta página deben estar correctamente enlazadas mediante rutas relativas que suban un nivel hacia la carpeta img.`,notebook:`Título: Organización de contenido en HTML. 1. Copia el dictado. 2. Responde: ¿Qué es una cronología? ¿Por qué es importante organizar la información?`,practice:`1. Crear paginas/cronologia.html. 2. Agregar título y lista ordenada con al menos 5 elementos históricos. 3. Insertar mínimo 4 imágenes usando ../img/archivo.jpg. 4. Agregar navegación: <a href="../index.html">Inicio</a> y <a href="juegos.html">Juegos</a>. 5. Guardar y probar en navegador.`,code:`<!-- Lista ordenada — recuerda la ruta desde paginas/ -->
<ol>
  <li></li>
  <li></li>
  <li></li>
...
<img src="" alt="">`,codeRef:`<ol>
  <li>1996 — Resident Evil</li>
  <li>1998 — Resident Evil 2</li>
  <li>2005 — Resident Evil 4</li>
</ol>

<img src="../img/re1.jpg" alt="Resident Evil 1">`,product:`Página cronologia.html funcional con imágenes y navegación correcta`,teacherNotes:`Aquí se evalúa la organización del contenido y el uso consistente de rutas relativas entre archivos de la misma carpeta.`},{time:`Hora 3`,title:`Página contacto.html y navegación completa`,theory:`Un sitio web debe permitir navegación entre todas sus páginas sin errores. Cada página debe tener enlaces redundantes que permitan regresar al inicio o moverse a secciones clave. Además, el sitio en este punto ya debe integrar formularios básicos para capturar información del usuario.`,notebook:`Título: Navegación en un sitio web. 1. Copia el dictado. 2. Responde: ¿Qué pasa si una ruta está mal escrita? ¿Por qué es importante la navegación?`,practice:`1. Crear paginas/contacto.html con estructura de formulario básica (nombre, correo, comentario, botón). 2. Agregar navegación: <a href="../index.html">Inicio</a> y <a href="personajes.html">Personajes</a>. 3. En index.html, agregar enlaces a juegos.html, cronologia.html y contacto.html. 4. Probar la navegación completa del sitio.`,code:`<!-- ¿Cuál es la ruta correcta desde paginas/ hacia index.html? -->
<a href="">Inicio</a>

<!-- ¿Y hacia otra página en la misma carpeta paginas/? -->
<a href="">Juegos</a>`,codeRef:`<a href="../index.html">Inicio</a>

<!-- Desde paginas/ a otra en paginas/ no necesita ../ -->
<a href="juegos.html">Juegos</a>`,product:`Sitio web completo con navegación funcional entre todas las páginas`,teacherNotes:`Aquí deben probar todo el sitio antes de darlo por terminado. No permitir que entreguen sin verificar la integridad de todos los enlaces.`}],cierre:`Hoy aprendiste a ubicarte dentro de tu propio proyecto… eso es lo que hace que un sitio web funcione correctamente.`,frase_docente:`Si entiendes las rutas, puedes conectar todo tu sitio web.`},{id:`thu`,label:`Jueves — Cronología y Contacto: completar el sitio`,purpose:`Crear las dos páginas restantes del sitio (cronologia.html y contacto.html) aplicando rutas relativas para imágenes y navegación, dejando el sitio de 5 páginas completamente funcional.`,hours:[{time:`Hora 1`,title:`Página cronologia.html con imágenes`,theory:`Una cronología organiza eventos en orden cronológico. En HTML se usa la lista ordenada <ol> para estructurar esa información de forma clara y jerárquica. Las imágenes siguen la misma lógica de rutas relativas que aplicamos en juegos.html: desde la carpeta paginas/ se sube un nivel con ../ para llegar a la carpeta img/. Si la ruta está mal escrita, la imagen no se mostrará — exactamente el mismo principio del lunes.`,notebook:`Título: cronologia.html — lista ordenada e imágenes. 1. Copia el dictado completo. 2. Dibuja la estructura de carpetas recordando desde dónde estás escribiendo la ruta. 3. Responde: ¿qué etiqueta se usa para una lista ordenada? ¿cómo se escribe la ruta de una imagen desde paginas/? ¿qué diferencia hay entre <ol> y <ul>? 4. Escribe la ruta correcta para llegar a ../img/ desde paginas/cronologia.html.`,practice:`1. Crear el archivo paginas/cronologia.html con estructura básica HTML5.
...
8. Corregir errores antes de continuar.`,code:`<!DOCTYPE html>
<html lang="es">
<head>
  <meta charset="UTF-8">
...
</html>`,product:`Página cronologia.html funcional con lista ordenada, mínimo 4 imágenes y navegación correcta hacia index, personajes y juegos.`,teacherNotes:`👨‍🏫 NOTA DOCENTE: Insistir en que es la misma lógica de rutas que el lunes — no es contenido nuevo, es práctica repetida. Si un alumno tiene imágenes rotas, hacer que trace mentalmente el camino: 'estoy en paginas/, necesito subir un nivel con ../ para llegar a img/'. No dar la respuesta directa, guiar el razonamiento.`},{time:`Hora 2`,title:`Página contacto.html y mejora de interfaz HTML`,theory:`La página de contacto es el punto de comunicación entre el usuario y el sitio. Un formulario bien estructurado usa etiquetas <label> vinculadas a sus campos con el atributo for y el id del input correspondiente — esto mejora la accesibilidad y la experiencia del usuario. Además, en esta hora vamos a mejorar la interfaz HTML del sitio agregando atributos semánticos que hacen que la página sea más clara visualmente aunque aún no tenga CSS: usar placeholder en los inputs, agregar un <footer>, y asegurarse de que cada página tenga una estructura coherente con header, nav, main y footer.`,notebook:`Título: contacto.html — formulario y estructura semántica. 1. Copia el dictado. 2. Escribe qué hace el atributo for en un <label> y para qué sirve el atributo id en un <input>. 3. Lista las etiquetas semánticas que debe tener una página completa: header, nav, main, footer. 4. Responde: ¿qué es el placeholder y por qué mejora la experiencia del usuario?`,practice:`1. Crear el archivo paginas/contacto.html con estructura HTML5 completa usando <header>, <nav>, <main> y <footer>.
...
7. Capturar el sitio funcionando en el navegador.`,code:`<!DOCTYPE html>
<html lang="es">
<head>
  <meta charset="UTF-8">
...
</html>`,product:`Página contacto.html completa con formulario semántico, navegación hacia las 4 páginas del sitio y estructura header/nav/main/footer. Sitio de 5 páginas completamente funcional y navegable.`,teacherNotes:`👨‍🏫 NOTA DOCENTE: El cierre de esta hora es la prueba completa del sitio. Pedir a los alumnos que naveguen por cada página sin saltar pasos: Inicio → Personajes → Juegos → Cronología → Contacto → regreso a Inicio. Si algún enlace falla, deben encontrar el error ellos mismos antes de pedir ayuda. Al final, quien tenga las 5 páginas funcionando tiene el proyecto base listo para recibir CSS.`}],cierre:`Hoy completaste las 5 páginas de tu sitio. Ya tienes una estructura real de proyecto web: organización de carpetas, rutas relativas, imágenes y navegación completa entre todas las páginas.`,frase_docente:`Un sitio no es una página — es una red. Hoy terminaste de conectar la tuya.`},{id:`fri`,label:`Viernes — Repaso del sitio + Introducción a CSS`,purpose:`Verificar que el sitio de 5 páginas esté completamente funcional y dar los primeros pasos con CSS para cambiar la apariencia visual del sitio.`,hours:[{time:`Hora 1`,title:`Repaso: auditoría del sitio de 5 páginas`,theory:`Un sitio web no está terminado hasta que cada página carga correctamente, todas las imágenes aparecen y todos los enlaces funcionan en ambas direcciones. Antes de agregar CSS, la estructura HTML debe ser sólida — un error de ruta o un enlace roto se vuelve invisible bajo los estilos y es mucho más difícil de corregir después.`,notebook:`Título: Checklist del sitio completo.
...
4. Dibuja el mapa de navegación completo del sitio.`,practice:`1. Abrir index.html en el navegador.
...
6. Anotar en libreta los errores encontrados y cómo se corrigieron.`,code:`<!-- Checklist: completa los href correctos -->
...
<img src="" alt="">`,codeRef:`<!-- Desde index.html hacia páginas hijas -->
...
<!-- Imagen desde paginas/ hacia img/ -->
<img src="../img/re1.jpg" alt="Resident Evil 1">`,product:`Sitio auditado: 5 páginas funcionales, imágenes cargando, navegación completa sin errores.`,teacherNotes:`👨‍🏫 NOTA DOCENTE: Esta hora es diagnóstica. No es tiempo libre — es revisión sistemática. El alumno que diga 'ya lo tengo' debe demostrarlo navegando el sitio completo delante del docente. Los errores más comunes: href sin paginas/ desde index, o sin ../ desde páginas hijas. Quien termina antes ayuda a quien tiene errores.`},{time:`Hora 2`,title:`CSS: vincular hoja de estilos y primeras propiedades`,theory:`CSS (Cascading Style Sheets — Hojas de Estilo en Cascada) es el lenguaje que controla la apariencia visual de las páginas HTML. Se escribe en un archivo separado con extensión .css y se vincula al HTML mediante la etiqueta <link> dentro del <head>. La sintaxis básica es: selector { propiedad: valor; }. El selector indica a qué elemento HTML se aplica el estilo, la propiedad qué aspecto se cambia, y el valor cómo queda.`,notebook:`Título: Introducción a CSS.
...
4. Escribe la regla CSS para poner el fondo del body en color negro y el texto en blanco.`,practice:`1. Crear la carpeta css/ dentro de tu proyecto (si no existe).
...
6. Si no aparecen: revisar la ruta del href en el link.`,code:`/* Completa las propiedades y valores */
...
/* <link rel="stylesheet" href="css/style.css"> */`,product:`Archivo css/style.css creado y vinculado a index.html con estilos básicos aplicados a body, h1 y p.`,teacherNotes:`👨‍🏫 NOTA DOCENTE: El error más frecuente es la ruta del link. Desde index.html la ruta es css/style.css (sin ../). Desde paginas/ sería ../css/style.css — ese punto se aborda en la hora 3. Enfocarse primero en que funcione en index.html antes de extenderlo a las demás páginas.`},{time:`Hora 3`,title:`CSS: estilizar el nav, colores y tipografía`,theory:`El nav es uno de los elementos más importantes visualmente porque aparece en todas las páginas. Con CSS podemos cambiar su color de fondo, el espaciado entre los enlaces y el comportamiento al pasar el cursor (hover). La pseudo-clase :hover permite aplicar estilos solo cuando el usuario pasa el mouse sobre un elemento — esto hace la navegación más intuitiva y profesional.`,notebook:`Título: Estilizar el nav con CSS.
...
4. Dibuja cómo se vería tu nav antes y después de aplicar CSS.`,practice:`1. En style.css agregar estilos para el nav:
...
5. Verificar que el nav se vea igual en las 5 páginas.`,code:`/* Completa los valores para el nav */
...
/* <link rel="stylesheet" href="../css/style.css"> */`,product:`Nav estilizado y consistente en las 5 páginas del sitio. Primeros estilos CSS funcionales con hover interactivo.`,teacherNotes:`👨‍🏫 NOTA DOCENTE: El punto crítico de esta hora es la ruta del link en las páginas hijas: ../css/style.css (con ../). Si olvidan el ../ el CSS no aplica. Hacer que lo comparen con la ruta de las imágenes — es la misma lógica. El cierre ideal es que el nav se vea idéntico al navegar entre las 5 páginas.`}],cierre:`Hoy tu sitio dejó de ser solo estructura y comenzó a tener identidad visual. El mismo CSS que vinculaste hoy puede evolucionar durante todo el semestre.`,frase_docente:`HTML construye la casa. CSS la decora. Hoy pusiste el primer color en las paredes.`},{id:`dual`,label:`Repositorio de Actividades Duales (Semana 08)`,activities:[{title:`Tarea 1: Rutas Relativas y Estructura`,instruction:`De acuerdo con la infografía 'Rutas Relativas en un Sitio Web': 1. Identifica tu ubicación actual antes de escribir una ruta. 2. Usa ../ para subir de nivel cuando estés dentro de la carpeta 'paginas'. 3. Asegúrate de que la ruta Locación -> Destino sea correcta para que las imágenes se visualicen.`,image:`infografia_semana_08.png`},{title:`Tarea 2: Completar el Sitio Web de 5 Páginas`,instruction:`De acuerdo con la infografía 'Completar el sitio web de 5 páginas': 1. Crea cronologia.html con lista ordenada <ol> y mínimo 4 imágenes usando rutas relativas ../img/. 2. Crea contacto.html con formulario semántico usando <label for> vinculado al <input id> correspondiente. 3. Verifica que las 5 páginas (index, personajes, juegos, cronología, contacto) estén conectadas entre sí mediante navegación.`,image:`s8_info02.png`}]}]},W09:{materia:`dewe`,weekId:`W09`,days:[{id:`mon`,label:`Lunes — CSS completo en todo el sitio`,purpose:`Concluir la vinculación del CSS a las páginas pendientes y aprender a estilizar imágenes con efectos hover y organizar el contenido con Flexbox, todo desde un único archivo style.css.`,hours:[{time:`Hora 1`,title:`Vincular style.css a todas las páginas del sitio`,theory:`Un sitio web profesional mantiene un único archivo CSS compartido por todas sus páginas. Esto garantiza que el diseño sea consistente — si cambias el color del nav en style.css, cambia en las 5 páginas al mismo tiempo. La única diferencia entre vincular desde index.html y desde las páginas hijas es la ruta: desde paginas/ hay que subir un nivel con ../ igual que se hace con las imágenes.`,notebook:`Título: Un CSS para todo el sitio.
...
4. ¿En qué se parece la ruta del CSS a la ruta de las imágenes desde paginas/?`,practice:`1. Abrir paginas/personajes.html en el editor.
...
7. Si una página no aplica estilos: revisar que el <link> esté dentro del <head> y que la ruta tenga ../`,code:`<!-- En index.html (ya lo tienen) -->
...
<link rel="stylesheet" href="">`,codeRef:`<!-- En index.html -->
<link rel="stylesheet" href="css/style.css">
...
<!-- En paginas/cronologia.html -->
<link rel="stylesheet" href="../css/style.css">`,product:`Las 5 páginas del sitio con el mismo CSS aplicado — diseño consistente y unificado.`,teacherNotes:`👨‍🏫 NOTA DOCENTE: El error más común es poner css/style.css en las páginas hijas en lugar de ../css/style.css. Antes de avanzar a H2 verificar que TODOS tengan las 5 páginas con estilos. Quien tenga errores: comparar la ruta del CSS con la ruta de sus imágenes — es exactamente la misma lógica con ../`},{time:`Hora 2`,title:`CSS: imágenes con estilo y efecto hover`,theory:`Las imágenes sin CSS se muestran en su tamaño original y sin ningún acabado visual. Con CSS podemos limitarlas a un ancho máximo para que no rompan el layout, redondear sus esquinas con border-radius y agregar una sombra con box-shadow para darles profundidad. La propiedad transition permite que los cambios de estilo ocurran de forma suave en lugar de instantánea — combinada con transform en :hover produce el efecto de zoom que hace que las imágenes se sientan interactivas.`,notebook:`Título: Estilizar imágenes con CSS.
...
4. ¿Por qué se necesita transition para que el efecto hover se vea suave?`,practice:`1. Abrir css/style.css.
...
6. Verificar que el efecto funciona en juegos.html, personajes.html y cronologia.html sin tocar esos archivos.`,code:`/* Agrega estas reglas en style.css */
...
}`,product:`Todas las imágenes del sitio con esquinas redondeadas, sombra y efecto de zoom al pasar el cursor.`,teacherNotes:`👨‍🏫 NOTA DOCENTE: Este es el momento más visual de la semana — los alumnos ven el efecto hover en tiempo real. Dejar que experimenten con los valores: border-radius: 50% hace círculo, box-shadow acepta colores (pueden poner rojo para tema RE). No corregir los valores creativos, solo los errores de sintaxis.`},{time:`Hora 3`,title:`CSS: Flexbox para galería y centrado del contenido`,theory:`Flexbox es un sistema de CSS que organiza elementos en filas o columnas de forma automática y flexible. Al aplicar display: flex a un contenedor, todos sus hijos se acomodan en fila. Con flex-wrap: wrap se permite que los elementos pasen a la siguiente línea cuando ya no caben — esto crea galerías responsive sin JavaScript. La propiedad gap controla el espacio entre elementos y justify-content centra o distribuye el contenido horizontalmente.`,notebook:`Título: Flexbox en CSS.
...
4. Dibuja cómo se verían 5 imágenes sin Flexbox vs con Flexbox y flex-wrap: wrap.`,practice:`1. En cada página con galería de imágenes (juegos, personajes, cronologia), envolver las imágenes en un <div class="galeria"> si no lo tienen ya.
...
5. Cambiar el tamaño de la ventana del navegador para ver cómo se reorganizan solas.`,code:`/* Agrega en style.css */
...
}`,product:`Galería de imágenes organizada en filas con Flexbox y contenido centrado en todas las páginas.`,teacherNotes:`👨‍🏫 NOTA DOCENTE: Lo más común es que apliquen display:flex al elemento img en lugar del contenedor — recordar que Flexbox se aplica al padre. Si no tienen un div.galeria, pedirles que lo agreguen solo en la página donde lo necesiten. El efecto de redimensionar la ventana y ver las imágenes reorganizarse solas siempre genera reacción positiva.`}],cierre:`Hoy el sitio pasó de HTML puro a tener un diseño unificado, imágenes con acabado profesional y una galería que se organiza sola. Todo con un único archivo CSS.`,frase_docente:`Un buen CSS hace que el mismo HTML se vea completamente diferente. Hoy lo comprobaste.`},{id:`thu`,label:`Jueves — CSS: estilizar el nav`,purpose:`Transformar la barra de navegación de texto plano a un componente con identidad visual: color de fondo, espaciado, hover en los enlaces y destacar la página activa.`,hours:[{time:`Hora 1`,title:`CSS: color, hover y página activa en el nav`,theory:"El `<nav>` es el elemento más visto del sitio — aparece en todas las páginas. Sin CSS tiene fondo transparente y los enlaces se ven como texto subrayado azul. Con CSS podemos darle un color de fondo que defina el tema visual del sitio, quitar el subrayado de los enlaces con `text-decoration: none`, agregar padding para que los links sean más fáciles de clicar y usar `:hover` para que cambien de color al pasar el cursor. La clase `.activo` en el `<a>` de la página actual permite distinguir en qué sección está el usuario.",notebook:`Título: Estilizar el nav con CSS.
...
5. Escribe la regla CSS para que el nav tenga fondo oscuro y los enlaces sean blancos. → ________________________________`,practice:`1. Abrir css/style.css.
...
7. Guardar y verificar en las 5 páginas que el nav se ve igual y el enlace activo se distingue.`,code:`/* Agrega en style.css */
...
nav a.activo {
  ...
  color: #ffffff;
  font-weight: bold;
}`,product:`Nav con fondo oscuro, enlaces en fila, efecto hover y enlace activo visible en las 5 páginas del sitio.`,teacherNotes:`👨‍🏫 NOTA DOCENTE: El error más común es agregar class="activo" en TODOS los archivos al mismo enlace en lugar de al que corresponde a cada página. Verificar que en index.html el activo es 'Inicio', en juegos.html es 'Juegos', etc. Los colores del ejemplo usan el tema Resident Evil — dejar que los alumnos ajusten los colores a su propio tema. Quien termine antes: agregar \`position: sticky; top: 0;\` al nav para que quede fijo al hacer scroll.`},{time:`Hora 2`,title:`CSS: estilizar el footer`,theory:"El footer cierra el sitio visualmente igual que el nav lo abre. En HTML ya tienen un `<footer>` con texto como el nombre del sitio, el año o el autor. Con CSS le damos color de fondo que haga juego con el nav, centramos el texto con `text-align: center`, le damos `padding` para que no se vea apretado y separamos el contenido con `margin-top: auto` si el footer está dentro de un flex container. El resultado: el sitio tiene cabeza, cuerpo y pie — estructura visual completa.",notebook:`Título: El footer en CSS.
...
5. Escribe la regla CSS completa para un footer con fondo oscuro, texto blanco y centrado. → ________________________________`,practice:`1. Verificar que cada HTML tiene un <footer> con contenido (si no, agregarlo).
...
7. Guardar y verificar en las 5 páginas que el footer se ve igual en todas.`,code:`/* Agrega en style.css */
...
footer p {
  font-size: 14px;
}`,product:`Footer con color de fondo, texto centrado y padding aplicado en las 5 páginas del sitio.`,teacherNotes:"👨‍🏫 NOTA DOCENTE: Si el footer no llega al fondo de la página cuando el contenido es corto, es porque el body no ocupa el alto completo. Solución: agregar `min-height: 100vh; display: flex; flex-direction: column;` al body y `flex: 1;` al main. No es obligatorio resolverlo hoy — mencionarlo como curiosidad para quien pregunte. El color debe coincidir con el nav — recordar a los alumnos que consistencia visual = sitio profesional."}],cierre:`El nav arriba, el footer abajo — el sitio ya tiene estructura visual completa. Todo con el mismo archivo CSS.`,frase_docente:`El diseño no es decoración — es comunicación.`},{id:`fri`,label:`Viernes — Día del Trabajo (Sin clases)`,purpose:`No hay clases. 1 de mayo — Día Internacional del Trabajo.`,hours:[{time:`📅 Sin sesión`,title:`1 de Mayo — Día Internacional del Trabajo`,theory:`El 1 de mayo se conmemora el Día Internacional del Trabajo en memoria de los Mártires de Chicago: el 4 de mayo de 1886, obreros en huelga que exigían la jornada de 8 horas fueron reprimidos en la plaza Haymarket. Murieron trabajadores y policías, y varios líderes sindicales fueron ejecutados en juicios considerados injustos. En México es día de descanso obligatorio desde 1923. La jornada de 8 horas que hoy damos por sentada fue conquistada con esa lucha.`,notebook:`Reflexión (opcional para quien quiera):
...
`,product:`Las 5 respuestas en libreta + ejecución completa de los 9 pasos en consola. El alumno debe poder explicar por qué el paso 8 devuelve "string" aunque escriba un número.`,teacherNotes:`👨‍🏫 NOTA DOCENTE: El paso 4 es el experimento clave para entender const — vale la pena dejar que TODOS lo prueben y vean el TypeError. El paso 8-9 introduce el problema de la conversión de tipos: prompt siempre devuelve string. Si el grupo viene rápido, mostrar también que prompt("...") + 5 da "175" (concatenación) en lugar de 22 (suma) — es un error real que cometerán pronto.`}],cierre:`Variables y tipos quedaron firmes. El primer script real lo construiremos el jueves con calma, repartido en 3 horas.`,frase_docente:`Lo que esta semana parece detalle (let vs const, comillas vs backticks) la próxima semana es la diferencia entre código que corre y código que se rompe.`},{id:`thu`,label:`Jueves — 🟨 JavaScript: del setup al primer programa con if/else`,purpose:`Sesión de 2h que reabsorbe parte del contenido perdido del lunes. H1: conectar el archivo script.js al HTML (setup limpio + mensaje de carga). H2: primer programa interactivo con prompt + alert + if/else (2 rangos: Agente / Cadete).`,hours:[{time:`Hora 1`,title:`🔗 Conectar el archivo script.js al HTML`,theory:`La consola del navegador está bien para experimentar, pero el JS de verdad vive en archivos .js que el HTML carga al abrir la página. Esta hora la dedicamos solo a UNA cosa: crear el archivo y conectarlo correctamente. El programa con prompt y alert lo escribimos en la H2.
...
Que cada alumno tenga su archivo js/script.js creado, vinculado al HTML, mostrando un mensaje de carga en la consola del navegador. Sin código de programa todavía — eso es la próxima hora.`,notebook:`1. ¿Por qué movemos el JS de la consola a un archivo .js?
...
• Revisa que el <script> esté dentro de <head> y tenga defer.`,diagram:`<!DOCTYPE html>
<html lang="es">
<head>
<meta charset="UTF-8">
<style>
...
`,product:`Carpeta js/ creada con archivo script.js dentro, vinculada al index.html con la etiqueta <script src defer>, mostrando el mensaje '✅ script.js cargado correctamente' en la consola del navegador al abrir la página.`,teacherNotes:`👨‍🏫 NOTA DOCENTE: Esta hora vale por sí sola — no incluye prompt/alert, eso es la H2. El objetivo es que TODOS terminen con un script.js mostrando el mensaje de carga. Errores frecuentes: ruta src equivocada (escribir 'JS/' en lugar de 'js/'), olvidar defer, escribir Console.log con C mayúscula. Si alguien termina rápido, pídele que ayude a sus compañeros — todos deben entrar a la H2 con su archivo funcionando.`},{time:`Hora 2`,title:`📝 Primer programa interactivo — prompt, alert e if/else`,theory:`Ya tienes tu script.js vinculado al HTML (H1). Ahora vamos a hacerlo INTERACTIVO: que pregunte cosas al usuario y tome decisiones según lo que conteste. Tres herramientas nuevas:
...
🎯 OBJETIVO DE ESTA HORA
Que tu script.js pida nombre y edad al usuario, decida si es Agente (≥18) o Cadete (<18), y muestre un mensaje de bienvenida personalizado con su nombre y rango.`,notebook:`1. ¿Qué tipo de dato devuelve siempre prompt()?
...
5. ¿Qué devuelve prompt() si el usuario pulsa Cancelar?`,practice:`Abre tu js/script.js del H1 (que solo tiene el console.log de carga) y agrega debajo:
...
`,product:`Capturas del sitio modificado vía consola en modo apocalipsis (mínimo 3 cambios visibles). Libreta con las 6 respuestas de teoría + los 5 selectores que probaron + qué hicieron en el reto.`,teacherNotes:`👨‍🏫 NOTA DOCENTE: Esta hora es 100% consola — nadie toca script.js todavía. Hace falta que los alumnos VEAN que el cambio es instantáneo (sin F5) para que internalicen el modelo mental del DOM. Si un alumno se asusta porque 'rompió' su sitio: F5 vuelve todo al original — los cambios en consola son volátiles. Aprovechar el paso 7 (innerHTML que borra todo) para discutir la diferencia entre textContent (texto) e innerHTML (HTML — peligroso si viene de usuario por XSS, pero eso es de seguridad para más adelante). El reto 'modo apocalipsis' es deliberadamente abierto — los más creativos sorprenden.`}],cierre:`Primer asalto al DOM: una página que se modifica desde JS, sin recargar. El jueves le ponemos botones y un mini-juego.`,frase_docente:`Aprender el DOM es darle a tu sitio un teclado para hablarte.`},{id:`thu`,label:`Jueves — 🖱️ Eventos + Mini-proyecto Sistema de Vida (continuación)`,purpose:`Retomar lo que no alcanzamos el lunes. H1: addEventListener y botones que reaccionan al usuario. H2: Mini-proyecto integrador del Sistema de Vida (barra de vida, daño/curación, GAME OVER) que une todo lo aprendido en DOM, eventos y funciones.`,hours:[{time:`Hora 1`,title:`🖱️ Eventos — el sitio escucha al usuario`,theory:`🎧 LA IDEA: HASTA AHORA JS CORRÍA UNA VEZ
...
El reto de mouseover/mouseout es bueno para discutir hover puro CSS vs hover con JS (cuándo usar cada uno).`},{time:`Hora 2`,title:`❤️ Mini-proyecto: Sistema de vida del personaje (todo junto)`,theory:`🎯 LO QUE VAMOS A CONSTRUIR
...
• Olvidar la llamada inicial actualizar() al final → al cargar la página no se ven los datos iniciales (técnicamente sí porque el HTML los muestra, pero el patrón es siempre llamar al final).`}],cierre:`Dos horas, dos saltos: el sitio escucha al usuario y el primer mini-juego cobra vida. Cierre fuerte del corte 3.`,frase_docente:`Cuando un alumno hace clic y la página responde lo que ÉL escribió, el aprendizaje deja huella.`},{id:`fri`,label:`Viernes — 🚧 Por planear`,purpose:`Sesión de viernes con grupo completo (incluye los del dual). Se planeará tras el jueves.`,hours:[{time:`🚧 Por planear`,title:`🚧 Sesión por planear`,theory:`Posibles direcciones para esta sesión integradora con grupo completo:
...
nav a.activo {
  ...
  color: #ffffff;
  font-weight: bold;
}`,ot=(e,t)=>e.replace(`<link rel="stylesheet" href="css/style.css">`,`<style>${t}</style>`),st=(e,t)=>e.replace(`<link rel="stylesheet" href="../css/style.css">`,`<style>${t}</style>`),ct=it+`
...
footer {
  ...
  letter-spacing: 2px;
  text-transform: uppercase;
}`,dt=`    // ── Hora 1: Variables y console.log ─────────────────────
    ...
    console.log("Año: " + anio);`,ft=`    // ── Hora 2: getElementById + onclick ───────────────────
    ...
    }`,pt=`    // ── Hora 3: classList.toggle + modo claro ───────────────
    function toggleModo() {
...
`)}\n  <\/script>`,ht=`      <h2>Personajes principales</h2>
      ...
      <a href="paginas/personajes.html" class="btn-ver">ABRIR VISTA COMPLETA</a>`,gt=`<li><a href="#contacto">Contacto</a></li>
      <li>
      ...
      </li>`,_t=`<link rel="stylesheet" href="css/style.css">
  <style>
    /* ── W10 H3: Modo claro ───────────────────────────────── */
  ...
  </style>`,vt=lt.replace(`</body>`,mt(dt)+`

</body>`),yt=lt.replace(`      <h2>Personajes principales</h2>
      <a href="paginas/personajes.html" class="btn-ver">ABRIR VISTA COMPLETA</a>`,ht).replace(`</body>`,mt(dt,ft)+`

</body>`),bt=lt.replace(`<link rel="stylesheet" href="css/style.css">`,_t).replace(`      <h2>Personajes principales</h2>
      <a href="paginas/personajes.html" class="btn-ver">ABRIR VISTA COMPLETA</a>`,ht).replace(`<li><a href="#contacto">Contacto</a></li>`,gt).replace(`</body>`,mt(dt,ft,pt)+`

</body>`),xt=`// Agregar antes de </body> en index.html
...
console.log("Bienvenido a: " + titulo);
console.log("Versión: " + version);
console.log("Año: " + anio);`,St=`<!-- Agregar en #personajes, después del <h2> -->

<button onclick="mostrarInfo()">🔍 Más información</button>
<p id="info-extra" style="display:none; margin-top:8px; color:#888;">
  Los personajes son agentes especiales que combaten amenazas biológicas.
  Cada uno tiene habilidades únicas de combate y supervivencia.
</p>`,Ct=`// Agregar dentro del <script>
...
}`,wt=`/* Agregar en <head>, dentro de un <style> nuevo */
...
body.modo-claro h2 {
  color: #b91c1c;
}`,Tt=`<!-- Agregar en <nav>, al final de la <ul> -->
...
</li>`,Et=`// Agregar dentro del <script>
