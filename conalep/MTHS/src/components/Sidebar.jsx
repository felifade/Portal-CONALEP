...
const Sidebar = ({ activeWeek, onWeekSelect, currentWeek, isMobileOpen, onMobileClose }) => {
              ...
              <div key={ra.id} className={`ra-group ${hasActiveWeek ? 'ra-active' : ''}`}>
                <div className="ra-header" onClick={() => toggleRa(ra.id)}>
                  <ChevronRight
                    ...
                    style={{ transition: 'transform 0.2s ease', transform: isExpanded ? 'rotate(90deg)' : 'rotate(0deg)' }}
                  />
