export const W13 = {
  ...
  days: [
    {
      id: "tue",
      label: "Martes — 📝 Reporte de práctica BLE + 🚀 Extender Programa 04 con segundo LED",
      purpose: "Cerrar formalmente la práctica BLE de W12: Hora 1 dedicada a redactar y entregar el reporte (fotos de libreta, conexión y funcionamiento). Hora 2 retomamos el reto que no alcanzamos el jueves pasado — agregar un segundo LED al Programa 04 y controlarlo desde BLE Controller.",
      hours: [
        {
          time: "Hora 1",
...
`,
      ...
      cierre: "Hora 1 entregó la práctica formalmente — los reportes son la cara profesional de lo que aprenden. Hora 2 amplió el Programa 04 para controlar DOS LEDs en lugar de uno — ese pequeño cambio prueba que entendieron la estructura del código. La semana próxima usaremos lo aprendido para proyectos más ambiciosos.",
      frase_docente: "Lo que escribes (el reporte) es lo que queda. Lo que modificas (el código) es lo que demuestra. Hoy hicieron ambas."
    },
    {
      id: "wed",
      label: "Miércoles — 📅 Pendiente de planeación",
      purpose: "Día con sesión disponible (1 hora estándar de MTHS los miércoles). Plan a definir según avance de la hora del martes — posibles temas: presentaciones, retroalimentación de reportes, o continuación del Programa 04 extendido.",
      hours: [
        {
          time: "📅 Por definir",
          title: "📅 Pendiente de planeación",
          theory: "Esta hora aún no tiene plan formal. Posibles direcciones según el avance del martes:\n\n• OPCIÓN A — Retroalimentación de reportes: el docente comparte observaciones generales de los reportes de la hora 1 del martes y muestra ejemplos buenos para que el grupo aprenda.\n• OPCIÓN B — Continuación con un tercer LED: si el martes hora 2 fluyó bien, agregar un tercer LED en GPIO 18 con comandos '4', '5' y profundizar en patrones de extensión.\n• OPCIÓN C — Introducción a sensores: aprovechar el circuito existente para integrar un sensor analógico (potenciómetro, fotorresistencia LDR) en preparación para W14.\n\nEl plan se confirmará después del martes según cómo avance el grupo.",
          notebook: "Pendiente — la libreta de hoy depende del plan que se confirme.",
          practice: "Pendiente de planeación. Estar listos con el circuito de los 2 LEDs armado por si la opción elegida lo requiere.",
          product: "Sin entregable fijo aún.",
          teacherNotes: "👨‍🏫 NOTA DOCENTE: Esta hora se confirma después de cerrar la sesión del martes. Decisión rápida basada en: (a) cuántos terminaron el reporte (Hora 1 del martes), (b) cuántos lograron los 2 LEDs (Hora 2). Si ambas cosas se cumplieron en >70%, vamos por OPCIÓN B (tercer LED) o C (sensor analógico). Si no, OPCIÓN A (retroalimentación y consolidación)."
        }
      ],
      cierre: "Plan pendiente — se cierra una vez confirmado.",
      frase_docente: "Adaptarse al ritmo del grupo es parte del oficio docente."
    },
    {
      id: "thu",
      label: "Jueves — 📅 Pendiente de planeación",
      purpose: "Día con 2 horas de MTHS estándar. Plan a definir junto con la sesión del miércoles. Probablemente integración de sensores o introducción a proyecto final de RA 3.2.",
      hours: [
        {
          time: "📅 Por definir",
          title: "📅 Pendiente de planeación",
          theory: "Esta sesión cierra la semana 13 y abre la transición a W14 (cierre de RA 3.2). El plan se confirmará junto con el plan del miércoles según el avance del grupo.",
          notebook: "Pendiente.",
          practice: "Pendiente — probablemente integración de sensor o anteproyecto final.",
          product: "Pendiente.",
          teacherNotes: "👨‍🏫 NOTA DOCENTE: Esta sesión se planea junto con la del miércoles. Posibles temas: (a) integración de sensor analógico (LDR o potenciómetro) con los 2 LEDs, (b) introducción al proyecto final de RA 3.2 (sistema multi-sensor con BLE), (c) recuperación para quienes quedaron pendientes en martes."
        }
      ],
      cierre: "Plan pendiente — se cierra junto con la decisión del miércoles.",
      frase_docente: "El cierre de un RA es tan importante como su apertura — define lo que se llevan."
    }
  ]
};
